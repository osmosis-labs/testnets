# v15 to v16 Testnet Upgrade Guide

|                 |                                                              |
|-----------------|--------------------------------------------------------------|
| Chain-id        | `osmo-test-5`                                                |
| Upgrade Version | `v16.0.0-rc2-testnet`                                        |
| Upgrade Height  | 1541000                                                      |
| Countdown       | <https://testnet.mintscan.io/osmosis-testnet/blocks/1541000> |
...
Copy the current v15 osmosisd binary into the
...
cd $HOME/osmosis
git pull
git checkout v16.0.0-rc2-testnet
make build
