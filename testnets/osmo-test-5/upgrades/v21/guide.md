# v20 to v21 Testnet Upgrade Guide

|                 |                                                              |
|-----------------|--------------------------------------------------------------|
| Chain-id        | `osmo-test-5`                                                |
| Upgrade Version | `v21.0.0-rc2`                                                |
| Upgrade Height  | 3957000                                                         |
| Countdown       | <https://testnet.mintscan.io/osmosis-testnet/blocks/3957000>    |
...
Copy the current v20 osmosisd binary into the
cosmovisor/genesis folder and v20 folder.
...
Cosmovisor is now ready to be set up for v20.
...
Create the v21 folder, make the build, and copy the daemon over to that folder

```{.sh}
mkdir -p ~/.osmosisd/cosmovisor/upgrades/v21/bin
cd $HOME/osmosis
git pull
git checkout v21.0.0-rc2
make build
cp build/osmosisd ~/.osmosisd/cosmovisor/upgrades/v21/bin
```

Now, at the upgrade height, Cosmovisor will upgrade to the v21 binary

## Manual Option

1. Wait for Osmosis to reach the upgrade height (3957000)
