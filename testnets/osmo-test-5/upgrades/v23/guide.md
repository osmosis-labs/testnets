# v22 to v23 Testnet Upgrade Guide

|                 |                                                              |
|-----------------|--------------------------------------------------------------|
| Chain-id        | `osmo-test-5`                                                |
| Upgrade Version | `v23.0.0-rc1`                                                |
| Upgrade Height  | 5347500                                                      |
| Countdown       | <https://testnet.mintscan.io/osmosis-testnet/blocks/5347500> |
...
Copy the current v22 osmosisd binary into the
cosmovisor/genesis folder and v22 folder.
...
Cosmovisor is now ready to be set up for v22.
...
make build
cp build/osmosisd ~/.osmosisd/cosmovisor/upgrades/v23/bin
```

Now, at the upgrade height, Cosmovisor will upgrade to the v23 binary

## Manual Option

1. Wait for Osmosis to reach the upgrade height (5347500)
