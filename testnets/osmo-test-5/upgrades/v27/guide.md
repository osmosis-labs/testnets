# v26 to v27 Testnet Upgrade Guide

|                 |                                                         |
|-----------------|---------------------------------------------------------|
| Chain-id        | `osmo-test-5`                                           |
| Upgrade Version | `v27.0.0-rc1`                                           |
| Upgrade Height  | 12434500                                                 |
| Countdown       | <https://www.mintscan.io/osmosis-testnet/block/12434500> |
...
Copy the current v26 osmosisd binary into the
cosmovisor/genesis folder and v26 folder.
...
Cosmovisor is now ready to be set up for v26.
...
Create the v27 folder, make the build, and copy the daemon over to that folder

```{.sh}
mkdir -p ~/.osmosisd/cosmovisor/upgrades/v27/bin
cd $HOME/osmosis
git pull
git checkout v27.0.0-rc1
make build
cp build/osmosisd ~/.osmosisd/cosmovisor/upgrades/v27/bin
```

Now, at the upgrade height, Cosmovisor will upgrade to the v27 binary

## Manual Option

1. Wait for Osmosis to reach the upgrade height (12434500)
