# v28 to v29 Testnet Upgrade Guide

|                 |                                                          |
|-----------------|----------------------------------------------------------|
| Chain-id        | `osmo-test-5`                                            |
| Upgrade Version | `v29.0.0-rc1`                                            |
| Upgrade Height  | 27192200                                                 |
| Countdown       | <https://www.mintscan.io/osmosis-testnet/block/27192200> |
...
Copy the current v29 osmosisd binary into the
cosmovisor/genesis folder and v28 folder.
...
Cosmovisor is now ready to be set up for v28.
...
Create the v29 folder, make the build, and copy the daemon over to that folder
...
Now, at the upgrade height, Cosmovisor will upgrade to the v29 binary

## Manual Option

1. Wait for Osmosis to reach the upgrade height (27192200)
