# v21 to v21a Testnet Upgrade Guide

|                 |                                                              |
|-----------------|--------------------------------------------------------------|
| Chain-id        | `osmo-test-5`                                                |
| Upgrade Version | `v21.0.0-a-rc4-testnet`                                                |
| Upgrade Height  | 4079000                                                         |
| Countdown       | <https://testnet.mintscan.io/osmosis-testnet/blocks/4079000>    |
...
Copy the current v21 osmosisd binary into the
cosmovisor/genesis folder and v21 folder.
...
Cosmovisor is now ready to be set up for v21.
...
Create the v21a folder, make the build, and copy the daemon over to that folder

```{.sh}
mkdir -p ~/.osmosisd/cosmovisor/upgrades/v21a/bin
cd $HOME/osmosis
git pull
git checkout v21.0.0-a-rc4-testnet
make build
cp build/osmosisd ~/.osmosisd/cosmovisor/upgrades/v21a/bin
```

Now, at the upgrade height, Cosmovisor will upgrade to the v21a binary

## Manual Option

1. Wait for Osmosis to reach the upgrade height (4079000)
