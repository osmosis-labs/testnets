# v17b to v18 Testnet Upgrade Guide

|                 |                                                              |
|-----------------|--------------------------------------------------------------|
| Chain-id        | `osmo-test-5`                                                |
| Upgrade Version | `v18.0.0`                                                    |
| Upgrade Height  | 2333500                                                      |
| Countdown       | <https://testnet.mintscan.io/osmosis-testnet/blocks/2333500> |
...
Copy the current v17b osmosisd binary into the
cosmovisor/genesis folder and v17b folder.

```{.sh}
cp $GOPATH/bin/osmosisd ~/.osmosisd/cosmovisor/genesis/bin
mkdir -p ~/.osmosisd/cosmovisor/upgrades/v17b/bin
cp $GOPATH/bin/osmosisd ~/.osmosisd/cosmovisor/upgrades/v16/bin
```

Cosmovisor is now ready to be set up for v17b.
...
1. Wait for Osmosis to reach the upgrade height (2333500)
