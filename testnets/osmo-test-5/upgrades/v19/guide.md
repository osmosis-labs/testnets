# v18 to v19 Testnet Upgrade Guide

|                 |                                                              |
|-----------------|--------------------------------------------------------------|
| Chain-id        | `osmo-test-5`                                                |
| Upgrade Version | `v19.0.0-rc0`                                                |
| Upgrade Height  | 2428500                                                      |
| Countdown       | <https://testnet.mintscan.io/osmosis-testnet/blocks/2428500> |
...
Copy the current v18 osmosisd binary into the
cosmovisor/genesis folder and v18 folder.
...
Create the v19 folder, make the build, and copy the daemon over to that folder
...
1. Wait for Osmosis to reach the upgrade height (2428500)
